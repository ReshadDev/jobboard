...
if (isset($_GET['id'])) {
  ...
  // getting the count of reated jobs
      ...
      <div class="col-lg-8 mb-4 mb-lg-0">
        <div class="d-flex align-items-center">
          <div class="border p-2 d-inline-block mr-3 rounded">
            <img class="img-fluid" src="../users/user-images/<?php echo $row->company_image; ?>" alt="Image">
          </div>
          <div>
      ...
      <div class="row">
              ...
              <?php endif; ?>
                ...
                <?php if($checking_for_application->rowCount() == 0) : ?>
                  ...
                  <form class="col-6" action="job-single.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="form-group">
                      <input type="hidden" value="<?php echo $_SESSION['id']; ?>" name="worker_id" class="form-control" id="" placeholder="worker_id">
                    </div>
                    ...
                    <div class="form-group">
                      <input type="hidden" value="<?php echo $row->job_title; ?>" name="job_title" class="form-control" id="" placeholder="job_title">
                    </div>

                    <div class="form-group">
                      <input type="hidden" value="<?php echo $row->company_id; ?>" name="company_id" class="form-control" id="" placeholder="company_id">
                    </div>
        ...
        <div class="col-lg-4">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              <li class="mb-2"><strong class="text-black">Published on:</strong>
                <?php echo date('M', strtotime($row->created_at)) . ',' . date('d', strtotime($row->created_at)) . ' ' . date('Y', strtotime($row->created_at)); ?></li>
          ...
          <div class="bg-light p-3 border rounded">
            ...
            <div class="px-3">
              <a href="https://www.facebook.com/sharer.php?u<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
              <a href="https://twitter.com/intent/tweet?url=<?php echo $row->job_title; ?>&url=<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $row->id; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-twitter"></span></a>
              <a href="https://www.linkedin.com/shareArticle?url=<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $row->id; ?>" class="pt-3 pb-3 pr-3 pl-0"><span class="icon-linkedin"></span></a>
            </div>
          </div>
