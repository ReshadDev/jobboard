...
if(isset($_SESSION['type']) && $_SESSION['type'] !== 'Company') {
   ...
   if(isset($_POST['submit'])){
    ...
    // if all are empty then show error message
    ...
    OR empty($_POST['education_experience']) OR empty($_POST['other_benifits']) OR empty($_POST['company_email']) OR empty($_POST['company_name']) OR empty($_POST['company_id']) OR empty($_POST['company_image'] OR empty($_POST['job_category'])) 
      ...
      echo "<script>window.location.href = '" . APPURL . "/jobs/job-update.php?id=".$id."'</script>";
    }
        ...
        <div class="row mb-5">
          ...
          <form class="p-4 p-md-5 border rounded" action="job-update.php?id=<?php echo $id; ?>" method="post">
              ...
              <div class="form-group">
                ...
                <select  name="job_region" class="selectpicker border rounded" id="job-region" data-style="btn-black" data-width="100%" data-live-search="true" title="<?php echo $singleJob->job_region?>">
              ...
              <div class="form-group">
                ...
                <select name="experience" class="selectpicker border rounded"  data-style="btn-black" data-width="100%" data-live-search="true" title="Select Years of Experience">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="job_description" id="" cols="30" rows="7" class="form-control" placeholder="Write Job Description...">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="responsibilities" id="" cols="30" rows="7" class="form-control" placeholder="Write Responsibilities...">
                  <?php echo $singleJob->responsibilities;?>
                  </textarea>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <?php echo $singleJob->education_experience;?>
                  </textarea>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <?php echo $singleJob->other_benifits;?>
                  </textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                <input type="hidden" value="<?php echo $_SESSION['username'] ?>" name="company_name" class="form-control" id="" placeholder="Company Name">
              </div>
              <div class="form-group">
                <input type="hidden" value="<?php echo $_SESSION['id'] ?>" name="company_id" class="form-control" id="" placeholder="Company ID">
              </div>
              <div class="form-group">
                <input type="hidden" value="<?php echo $_SESSION['image'] ?>" name="company_image" class="form-control" id="" placeholder="Company Image">
              </div>
