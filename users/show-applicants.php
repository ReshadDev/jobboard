...
<section class="site-section">
  <div class="container">
    <ul class="job-listings mb-5">
      ...
      <li style=" height: 100px" class="d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
        <div class="job-listing-logo">
        <a style="text-decoration: none;"  target="_blank" class="" href="<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $jobApp->job_id?>">
          <img style=" height: 100px" src="./user-images/<?php echo $_SESSION['image'] ?>" alt="Free Website Template by Free-Template.co" class="img-fluid">
          </a>
        </div>
